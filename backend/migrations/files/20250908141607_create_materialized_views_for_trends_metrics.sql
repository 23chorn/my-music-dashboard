-- Migration: create materialized views for trends metrics
-- Description: Create materialized views for efficient multi-year trends calculation
...
-- Initial refresh of materialized views (will be empty until data is loaded)
