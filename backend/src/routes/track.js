...
router.get('/all', (req, res) => {
  ...
  logger.info(`GET /api/tracks/all called with page=${page}, limit=${limit}, sortBy=${sortBy}, alphaCategory=${alphaCategory}, minPlays=${minPlays}, maxPlays=${maxPlays}, releaseYearStart=${releaseYearStart}, releaseYearEnd=${releaseYearEnd}`);
