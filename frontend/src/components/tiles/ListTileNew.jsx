...
export default function ListTileNew({ label, value, sub, link, album }) {
  const mainContent = (
    <span>
  ...
  const baseClasses =
    "p-2 bg-gray-800 rounded flex flex-col md:flex-row md:justify-between items-start md:items-center transition";
