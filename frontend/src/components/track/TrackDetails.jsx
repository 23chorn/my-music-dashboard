export default function TrackDetails({ track }) {
  ...
  return (
    <div>
      <h3 className="text-sm font-semibold text-surface-400 uppercase tracking-wide mb-4">Details</h3>
      <div className="space-y-4">
        {track.duration_ms && (
          <div className="bg-surface-800 rounded-lg p-3 border border-surface-700">
            <div className="text-xs text-surface-400 uppercase tracking-wide mb-1">Duration</div>
            <div className="text-lg font-medium text-white">{formatDuration(track.duration_ms)}</div>
          </div>
        )}
        {track.popularity && (
          <div className="bg-surface-800 rounded-lg p-3 border border-surface-700">
            <div className="text-xs text-surface-400 uppercase tracking-wide mb-1">Spotify Popularity</div>
