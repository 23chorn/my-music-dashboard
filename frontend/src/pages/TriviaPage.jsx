...
export default function TriviaPage() {
  ...
  const [currentView, setCurrentView] = useState('overview'); // 'overview', 'session', 'history', 'stats'
      ...
      <PageLayout>
        <div className="max-w-4xl mx-auto px-4 py-8">
          <div className="text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-2">Error Loading Trivia</h2>
    ...
    <div className="max-w-6xl mx-auto px-4 py-8 space-y-8">
      ...
      <div className="text-center">
        <div className="flex justify-center mb-4">
          <PuzzlePieceIcon className="h-16 w-16 text-blue-600" />
        </div>
        <h1 className="text-4xl font-bold text-gray-900 mb-4">Music Trivia</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <button
          ...
          className="bg-gray-100 text-gray-900 p-6 rounded-lg hover:bg-gray-200 transition-colors group"
        >
          <ClockIcon className="h-8 w-8 mb-3 mx-auto text-gray-600 group-hover:scale-110 transition-transform" />
          <h3 className="font-semibold mb-2">Recent Sessions</h3>
          <p className="text-sm text-gray-600">View your trivia history</p>
        </button>
        ...
        <button
          ...
          className="bg-gray-100 text-gray-900 p-6 rounded-lg hover:bg-gray-200 transition-colors group"
        >
          <ChartBarIcon className="h-8 w-8 mb-3 mx-auto text-gray-600 group-hover:scale-110 transition-transform" />
          <h3 className="font-semibold mb-2">Statistics</h3>
          <p className="text-sm text-gray-600">Your trivia performance</p>
        </button>

        <Link
          to="/insights"
          className="bg-gray-100 text-gray-900 p-6 rounded-lg hover:bg-gray-200 transition-colors group block text-center"
        >
          <SparklesIcon className="h-8 w-8 mb-3 mx-auto text-gray-600 group-hover:scale-110 transition-transform" />
          <h3 className="font-semibold mb-2">AI Insights</h3>
          <p className="text-sm text-gray-600">Your listening analysis</p>
        </Link>
      </div>
      ...
      {stats && (
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="bg-white rounded-lg border border-gray-200 p-4 text-center">
            <div className="text-2xl font-bold text-blue-600">{stats.sessions.total_sessions || 0}</div>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-4 text-center">
            <div className="text-2xl font-bold text-purple-600">{stats.sessions.best_score || 0}</div>
            <div className="text-sm text-gray-600">Best Score</div>
          </div>
          <div className="bg-white rounded-lg border border-gray-200 p-4 text-center">
            <div className="text-2xl font-bold text-orange-600">{stats.categories?.length || 0}</div>
            <div className="text-sm text-gray-600">Categories Played</div>
          </div>
        </div>
      )}
      ...
      {themes.length > 0 && (
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">Trivia Themes</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {themes.map((theme) => (
              <div key={theme.id} className="border border-gray-200 rounded-lg p-4 hover:border-blue-300 transition-colors">
